class ChoreSeeder
  CHORE_DATA = [
    ...
    {name: "Empty Fridge", description: "Some of the stuff has been there for awhile, if it is yours - throw it in the trash", house: House.first, due: "2019-05-17 19:12:19"}
  ]
